  ...
  { documentUrl, conversationalTopics }: ExtractTextFromDocumentUrlInput
    ...
    try {
      ...
      if (rawError.includes("PROJECT_BILLING_NOT_ENABLED")) {
          detailedError = `CRITICAL: The text extraction feature failed because billing is not enabled for your Google Cloud project. Please go to your Google Cloud Console, select the correct project, and ensure that a billing account is linked.`;
