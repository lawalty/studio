...
export async function searchKnowledgeBase({
  ...
  if (!embeddingResult || !Array.isArray(embeddingResult) || embeddingResult.length === 0 || !embeddingResult[0].embedding) {
  ...
  const embeddingVector = embeddingResult[0].embedding;
