...
import { MessageSquare, Volume2, AlertTriangle } from 'lucide-react';
...
function AudioTextPageContent() {
  ...
  const handleStartConversation = () => {
    ...
    router.push('/?embedded=true&mode=audio-text');
  };
    ...
    <Card className="w-full max-w-md shadow-xl">
      <CardHeader className="text-center">
        <CardTitle className="text-3xl font-headline text-primary flex items-center justify-center gap-2">
          <Volume2 className="h-8 w-8" /> <MessageSquare className="h-8 w-8" /> Audio & Text Mode
        </CardTitle>
        <CardDescription>(Recommended) Interact with voice and see text.</CardDescription>
      </CardHeader>
